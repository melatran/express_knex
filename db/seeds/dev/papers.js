...
exports.seed = function(knex) {
  ...
  return knex('footnotes').del() //delete all footnotes first
    ...
    // Now we have a clean slate, we can re insert our paper data
    .then(() => {
      return Promise.all([
        // Insert a singer paper, return the id and inseert 2 footnotes
        knex('papers').insert({
          title: 'Foo', author: 'Bob', publisher: 'California'
        }, 'id')
        .then(paper => {
